...
var sliderCases = new _bundle.default('.cases__swiper', {
  effect: 'fade',
  slidesPerView: 1,
  loop: true,
  speed: 1500,
  ...
  on: {
    slideChange: function slideChange(e) {
      ...
      var preSlide = this.slides[this.previousIndex];
      curSlide.classList.add('js-animation');
      preSlide.classList.remove('js-animation');
    }
  }
});
exports.sliderCases = sliderCases;
var additionalSlider = new _bundle.default('.additional-serv__swiper', {
  slidesPerView: 1,
  // spaceBetween: 0,
  centeredSlides: true,
  loop: true,
